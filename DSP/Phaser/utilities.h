...
struct Util
{
    static inline float cubicInterpolate(float v0, float v1, float v2, float v3, float t);
...
inline float Util::cubicInterpolate(float v0, float v1, float v2, float v3, float t)
{
